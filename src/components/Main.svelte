<script>
    ...
    let steps = [
        ...
        {name:"Ultimate To-dos", icon:"fa-solid fa-list-check"},
        {name:"Pokedex", icon:"fa-solid fa-diagram-project"}
    ]

    let benefits = [
        {name: "a self taught developer", description: "Lorem ipsum...."},
        {name: "a product design & UX fanatic", description: "Lorem ipsum...."},
        {name: "an excellent communicator", description: "Lorem ipsum...."},
        ]
...
<main class="flex flex-col flex-1 p-4">
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
            ...
            <a href="https://www.linkedin.com/in/jbethancourt/" target="_blank" class="poppins blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950 cursor-pointer">
    ...
    <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
        ...
        <a href="https://youtube.com" target="_blank" class="mx-auto px-4 py-2 rounded-md border border-solid border-white flex items-center gap-2 -mb-4 sm:-mb-0 -mt-10 hover:border-violet-700 duration-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>SmolJames Store is a merchandizing store with <strong class="text-violet-400">Next.js, Commerce.js, Stripe, &amp; Express.js!</strong></p>    
            </Step>
            <Step step={steps[1]}>
                <p>Ultimate Todos is a fullstack todo checklist application <strong class="text-violet-400">Next.js, Commerce.js, Stripe, &amp; Express.js!</strong> CRUD application for keeping track of personalized To-Dos w/ login and cross-device persistence</p> 
            </Step>
            <Step step={steps[2]}>
                <p>Pokedex is a <strong class="text-violet-400">Next.js, Commerce.js, Stripe, &amp; Express.js!</strong></p> 
            </Step>
        </div>
    </section>

    <section id="about" class="py-20 pt-10 lg:pt16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
        ...
        <p class="popins mx-auto font-semibold text-lg sm:text-xl md:text-2xl">I am . . .</p>
        ...
        <h5 class="poppins text-2xl sm:text-3xl font-semibold text-center">The <span class="poppins text-violet-400">Complete</span> Package(yuck!)</h5>
